...
(не обрезанным) — ResultSheet честно показывает штраф отдельной строкой, даже когда итог `0`.
...
улучшить mastery (`bronze / silver / gold`). Три подразделения открывают по одной услуге,
