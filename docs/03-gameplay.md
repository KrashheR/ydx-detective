...
Точка входа в «Особые архивы» временно скрыта из десктопного сайдбара и мобильного меню.
Компоненты и данные каталога сохранены в коде для отдельного патча, но в текущей сборке
`ThematicPacksModal` недоступен игроку. Каталог содержит данные из
...
кампанию как L16-экспертные бюджетные fraud-расследования. После возвращения витрина снова даст
второй канал доступа поверх обычной кампании:
