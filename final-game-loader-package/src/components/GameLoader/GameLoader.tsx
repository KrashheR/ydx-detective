...
import desktopBackground from './assets/loader-bg-desktop.webp';
import mobileBackground from './assets/loader-bg-mobile.webp';
import { LOADER_COPY } from './loaderI18n';
...
export function GameLoader({
  ...
  const copy = mergeCopy(LOADER_COPY[locale], copyOverride);
