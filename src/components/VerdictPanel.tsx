      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          <button
            type="button"
            onClick={onReject}
            className={`h-[54px] w-full rounded-[9px] text-sm font-bold uppercase tracking-wide text-white transition-[filter] ${
              canReject
        ...
        <Tooltip className="block" label={canApprove ? null : approveBlockedReason}>
          <button
            type="button"
            onClick={onApprove}
            disabled={!canApprove}
